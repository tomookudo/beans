...
function showCalendar(events) {
  ...
  let div2 = document.createElement('div','input-group');
  // let sp = createElement('span','input-group-addon','GET');
  // div2.appendChild(sp);

  let getButton = createElement('button', 'btn btn-outline-secondary btn-sm mb-3', 'Get');
  getButton.setAttribute('type', 'button');
  getButton.setAttribute('onclick', 'getEventsByMail();');
  // sp.appendChild(getButton);
  div2.appendChild(getButton);

  let mailInput = createElement('input', 'form-control');
  mailInput.setAttribute('id', 'ev-mail');
  mailInput.setAttribute('type', 'email');
  // mailInput.setAttribute('size', '5');
  mailInput.setAttribute('placeholder', 'Enter email');
  mailInput.setAttribute('value', get_mailaddr);
  ...
  if(get_mailaddr){
    div.append(document.createElement("br"));
    div.appendChild(createElement('p', 'bg-info', get_mailaddr));
  }
